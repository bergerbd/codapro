...
@Component(name = "Or", doc = "Takes a set of boolean columns and calculates the or result. The result is append to the data vector.")
public class LogicalOrCalculator {

	@Input(doc="The name of the new column.", name="name")
	private String columnName;

	@ColumnId(doc="List of columns to 'or'.", name="columns", stream="input-stream")
	...
	public String toString() {
		return "Or [columns=" + Arrays.toString(columnIndices) + "]";
	}
}
